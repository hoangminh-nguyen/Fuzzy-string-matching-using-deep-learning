...
from .candidateRanker import candidate_ranker, candidate_ranker_trans
from .candidateRanker import main as candidate_ranker_main
from .combineVecs import combine_vecs,combine_vecs_trans
...
def train(input_file_path=None, dataset_path=None, model_name=None, 
    ...
    gru_lstm_network(dl_inputs=dl_inputs, 
                     ...
                     valid_dc=valid_dc, 
                     test_dc=test_dc)
    # transformer_network(dl_inputs=dl_inputs, 
    #                  model_name=model_name, 
    #                  train_dc=train_dc, 
    #                  valid_dc=valid_dc, 
    #                  test_dc=test_dc)
